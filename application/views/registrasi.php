                        ...
                        <div class="p-5">
                            ...
                            <form method="POST" action="<?php echo base_url('registrasi/index') ?>" class="user">
                                <div class="form-group">
                                    ...
                                    <?php echo form_error('nama', '<div class="text-danger text-small ml-2">', '</div>') ?>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Usernama" name="username">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <?php echo form_error('password_1', '<div class="text-danger text-small ml-2">', '</div>') ?>
                                    </div>
                                    <div class="col-sm-6">
